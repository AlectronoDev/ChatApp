...
export interface DeviceKeys {
  ...
  dhSecretB64: string;
  /** base64-encoded 32-byte X25519 DH public key */
  dhPublicB64: string;
  ...
  signedPrekeySecretB64: string;
  /** base64-encoded 32-byte X25519 signed-prekey public key */
  signedPrekeyPubB64: string;
  /** base64-encoded Ed25519 signature over (key_id_be || spk_pub_bytes) */
...
export function dhPublicKeyB64(secretB64: string): string {
 ...
 */
function ecdhSessionKey(ourSecretB64: string, theirPublicB64: string): Uint8Array {
